	...
	<div class="content">
		...
		<div class="card">
			...
			<div class="form-group">
				<a class="btn btn-default" href="<?= base_url('auth/create_group') ?>"><?= lang('index_create_group_link') ?></a>
				<a class="btn btn-default" href="<?= base_url('auth/create_user') ?>"><?= lang('index_create_user_link') ?></a>
			</div>
		</div>
	</div>
</div>
