...
<script src="<?php echo base_url()?>assets/konsumen/js/gritter/js/gritter-init.js" type="text/javascript"></script>
      ...
      $(document).ready(function() {
       $('#example').DataTable({
        ...
        "ajax":{
          url : "<?php echo site_url('Konsumen/data_server')?>",
          type : "POST"
        },
        "columnDefs":
        [
          ...
          },
		 {
            ...
            "searchable":false,
            "render":function(data,type,full,meta){
              return '<a href="<?=site_url()?>/konsumen/beli/'+data["id"]+'"><button type="button" class="btn btn-warning">Beli<i class="fa fa-fw fa-edit"></i></button></a>';
            }
          },
