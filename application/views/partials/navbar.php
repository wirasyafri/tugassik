...
<!-- 					
					...
					<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
						...
						<?php $user = $this->ion_auth->user()->row();?>
							<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false"> <img src="<?= base_url() ?>assets/img/profile.jpg" alt="user-img" width="36" class="img-circle"><span><?= $user->username ?></span></a>
