								...
								<div class="card">
									...
									<div class="card-body">
										<div class="form-group">
											...
											<input name="product" type="text" class="form-control" id="name" placeholder="Enter name">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<input name="qty" type="text" class="form-control" id="name" placeholder="Enter name">
										</div>
										<div class="form-group">
											<label for="name">Price</label>
											<input name="price" type="text" class="form-control" id="name" placeholder="Enter name">
										</div>
										<div class="form-group">
											<label for="name">Foto</label>
											<input name="foto" type="file" class="form-control" id="name" placeholder="Enter name">
										</div>
										</div>
